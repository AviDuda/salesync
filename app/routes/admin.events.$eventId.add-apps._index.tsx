...
import { Intent } from "./admin.events.$eventId.apps.select-platforms";
...
export async function loader({ request, params }: LoaderArgs) {
  ...
  let groupBy: GroupBy;
  groupBy = parsedSearchParams.success
    ? parsedSearchParams.data.groupBy ?? GroupBy.None
    : GroupBy.None;
  ...
  const apps = appsResult.filter((app) => app.appPlatforms.length > 0);
